...
function Player() {
  ...
  const {enrolledCourse , calculateChapterTime , backendUrl , getToken , userData , fetchUserEnrolledCourses } = useContext(AppContext) ; 
  ...
  return courseData ?  (
  <>
    <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-16 ">
      {/* left column */}
      <div className="text-gray-800">
        ...
        <div className="pt-5">
          {courseData && courseData.courseContent.map((chapter, index) => (
            ...
            >
              <div
                className="flex items-center justify-between px-4 py-3 cousor-pointer select-none"
