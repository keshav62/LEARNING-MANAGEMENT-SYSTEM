...
function MyEnrollements() {
  ...
  const {enrolledCourse, calculateCourseDuration , navigate ,fetchUserEnrolledCourses, backendUrl, getToken , userData , calculateNoOfLectures} = useContext(AppContext) ; 
